...
def configure(dataset: str) -> None:
    global DATASET, CFG, PATHS, RAW_LOG, PARSED, FEATURES, SCORES, MODEL, METRICS
    global WINDOW, STEP, HAS_LABELS, EVALUATION_MODE
...
def write_metrics(scores: pd.DataFrame, path: Path | None = None) -> dict:
